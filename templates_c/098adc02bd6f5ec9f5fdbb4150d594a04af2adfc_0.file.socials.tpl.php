<?php
/* Smarty version 4.4.1, created on 2024-03-17 20:23:33
  from 'C:\xampp\htdocs\Mosaic\src\templates\fragments\socials.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.4.1',
  'unifunc' => 'content_65f74335998578_48238553',
...
function content_65f74335998578_48238553 (Smarty_Internal_Template $_smarty_tpl) {
?>

<div class=" p-4 rounded-md">
    <?php if ($_smarty_tpl->tpl_vars['fragmentContent']->value["GithubLink"] && $_smarty_tpl->tpl_vars['fragmentContent']->value[''] != "NULL") {?>
        <div class="mb-4">
...
" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Github</a>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['fragmentContent']->value["GitlabLink"] && $_smarty_tpl->tpl_vars['fragmentContent']->value[''] != "NULL") {?>
        <div class="mb-4">
...
" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Gitlab</a>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['fragmentContent']->value["XLink"] && $_smarty_tpl->tpl_vars['fragmentContent']->value[''] != "NULL") {?>
        <div class="mb-4">
...
" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">X</a>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['fragmentContent']->value["FacebookLink"] && $_smarty_tpl->tpl_vars['fragmentContent']->value[''] != "NULL") {?>
        <div class="mb-4">
...
" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Facebook</a>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['fragmentContent']->value["RedditLink"] && $_smarty_tpl->tpl_vars['fragmentContent']->value[''] != "NULL") {?>
        <div class="mb-4">
...
" class="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Reddit</a>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['fragmentContent']->value["DiscordLink"] && $_smarty_tpl->tpl_vars['fragmentContent']->value[''] != "NULL") {?>
        <div class="mb-4">
